...
class Estrella():
    ...
    def tipo_espectral(self):
        """
        Calcula el tipo espectral de la estrella basado en su temperatura superficial.
        ...
        if self._teff < 3500:
            return "M"
        elif self._teff < 5000:
            return "K"
        elif self._teff < 6000:
            return "G"
        elif self._teff < 7500:
            return "F"
        elif self._teff < 10000:
            return "A"
        elif self._teff < 30000:
            return "B"
        else:
            return "O"
